...
export const STATIC_META: Record<string, Meta> = {
  "/": { title: "Fraser Valley Presale Advisor | Uzair Muhammad", description: "Presale advice before you sign. Buyer-side guidance for first-time buyers and investors across Surrey, Langley, Delta, South Surrey, Abbotsford and the Fraser Valley. Uzair represents buyers only, never developers, and works in Punjabi, Hindi, Urdu and English.", image: DEFAULT_IMAGE },
...
const CITY_CONTENT: Record<string, CityContent> = {
  "/surrey": { name: "Surrey", intro: "Surrey is the fastest-growing city in BC and its presale market moves fast. Whether you're looking in Surrey City Centre, Fleetwood, Clayton, or South Surrey, Uzair Muhammad gives you buyer-only VIP access to new presale condos and townhomes — with early pricing and full contract protection.", why: "With the Surrey–Langley SkyTrain extension and major infrastructure investment, Surrey offers some of the strongest appreciation potential in the Fraser Valley. Not every project is a good deal — Uzair analyzes the developer's track record, the deposit structure, and the assignment clauses so your investment is protected.", faqs: [ { q: "Who is the best presale realtor in Surrey?", a: "Uzair Muhammad is a buyer-only presale specialist who has sold 450+ new-construction units and represents buyers only — never developers — across Surrey and the Fraser Valley." }, { q: "How much do presale condos cost in Surrey?", a: "Surrey presale condos generally start in the high $400s, with pricing driven by location and completion timing. Uzair provides current floor plans and pricing on request." }, { q: "Do I pay to use a buyer's agent for a Surrey presale?", a: "For many presale projects, the buyer-agent commission is paid through the project's sales structure, so representation typically costs the buyer nothing. Uzair confirms exactly how it works on each specific project before you commit." } ] },
...
export const FUNNEL: Record<string, FunnelPage> = {
  "/new-to-presale-start-here": {
    ...
    sections: [
      ...
      { h: "How I help — buyer-only representation", p: "I represent buyers only. For many presale projects my commission is paid through the project's sales structure, and I represent you — never the builder. I'll explain exactly how it works on your project before you move forward. Going direct to the sales centre doesn't save you money — it removes your representation from the deal." },
    ],
    faqs: [
