...
export const STATIC_META: Record<string, Meta> = {
  "/": { title: "Fraser Valley Presale Advisor | Uzair Muhammad", description: "Presale advice before you sign. Buyer-side guidance for new condos, townhomes, and homes across Surrey, Langley, Delta, South Surrey, Abbotsford, and the Fraser Valley.", image: DEFAULT_IMAGE },
