...
const CITY_CONTENT: Record<string, CityContent> = {
  "/surrey": { name: "Surrey", intro: "Surrey is the fastest-growing city in BC and its presale market moves fast. Whether you're looking in Surrey City Centre, Fleetwood, Clayton, or South Surrey, Uzair Muhammad gives you buyer-first VIP access to new presale condos and townhomes — with early pricing and full contract protection.", why: "With the Surrey–Langley SkyTrain extension and major infrastructure investment, Surrey offers some of the strongest appreciation potential in the Fraser Valley. Not every project is a good deal — Uzair analyzes the developer's track record, the deposit structure, and the assignment clauses so your investment is protected.", faqs: [ { q: "Who is the best presale realtor in Surrey?", a: "Uzair Muhammad is a presale specialist who represents buyers, not developers who has sold 450+ new-construction units and represents buyers only — never developers — across Surrey and the Fraser Valley." }, { q: "How much do presale condos cost in Surrey?", a: "Surrey presale condos generally start in the high $400s, with pricing driven by location and completion timing. Uzair provides current floor plans and pricing on request." }, { q: "Do I pay to use a buyer's agent for a Surrey presale?", a: "For many presale projects, the buyer-agent commission is paid through the project's sales structure, so representation typically costs the buyer nothing. Uzair confirms exactly how it works on each specific project before you commit." } ] },
  "/langley": { name: "Langley", intro: "Langley is the top destination for Fraser Valley families and investors looking for space and growth. Uzair Muhammad gives you buyer-first VIP access to the most sought-after new-construction townhomes and condos in Willoughby, Latimer Heights, and Central Langley.", why: "Langley pairs family-friendly communities with rapid transit development. As Willoughby and the SkyTrain corridor build out, getting in early matters. Uzair helps you cut through the hype, negotiate the best terms, and secure a home that fits your financial goals.", faqs: [ { q: "Who is the best presale agent in Langley?", a: "Uzair Muhammad is a buyer-first Langley presale specialist with deep knowledge of Willoughby, Latimer Heights, and Yorkson, and 450+ new-construction units sold." }, { q: "Is Langley good for presale townhomes?", a: "Yes — Langley is townhome country, with strong family demand and appreciation along the coming SkyTrain corridor. Uzair knows every active project and developer." } ] },
