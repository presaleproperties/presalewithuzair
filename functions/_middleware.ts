...
export const STATIC_META: Record<string, Meta> = {
  "/": { title: "Fraser Valley Presale Advisor | Uzair Muhammad", description: "Presale advice before you sign. Buyer-side guidance for condos, townhomes, and new homes across Surrey, Langley, Delta, South Surrey, and Abbotsford. English, Punjabi, Hindi, Urdu.", image: DEFAULT_IMAGE },
