...
const heroContent = {
  ...
  body: "I help buyers cut through the sales pitch, understand what really matters, and decide whether the Presale Project is actually right for them. English Punjabi · Hindi · Urdu.",
