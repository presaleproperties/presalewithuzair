...
export const InstagramSection = () => {
  return (
    <section className="py-16 sm:py-24 bg-card/30 relative overflow-hidden">
      {/* Navy/gold depth effects */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-10 right-[15%] w-32 h-32 rounded-full bg-primary/8 blur-3xl" />
        <div className="absolute bottom-10 left-[10%] w-40 h-40 rounded-full bg-primary/6 blur-3xl" />
      </div>

      <div className="relative z-10 container-xl px-4 sm:px-6">
        <div className="max-w-2xl mx-auto text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-primary/80 via-primary to-accent mb-6">
