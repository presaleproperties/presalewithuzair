      ...
      <div className="container-xl relative z-10 py-10 md:py-16 px-5 sm:px-8 lg:px-16">
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between mb-8">
            ...
            <div className="flex items-center gap-2.5">
              <a
                ...
                onClick={trackPhone}
                className="w-10 h-10 rounded-sm border border-white/15 flex items-center justify-center text-white/70 transition-colors duration-300 hover:border-white/50 hover:text-white"
              >
          ...
          <div className="flex flex-wrap gap-x-5 gap-y-2.5 mb-8 text-sm">
            ...
            <Link to="/punjabi-speaking-realtor" className="text-white/75 hover:text-white transition-colors duration-300">Punjabi Realtor</Link>
            <Link to="/hindi-speaking-realtor" className="text-white/75 hover:text-white transition-colors duration-300">Hindi Realtor</Link>
            <Link to="/urdu-speaking-realtor" className="text-white/75 hover:text-white transition-colors duration-300">Urdu Realtor</Link>
            <Link to="/south-asian-buyers" className="text-white/75 hover:text-white transition-colors duration-300">South Asian Buyers</Link>
          </div>
            ...
            <div className="lg:col-span-1">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  rel="noopener noreferrer"
                  onClick={trackWa}
                  className="w-9 h-9 rounded-sm border border-white/15 flex items-center justify-center text-white/60 transition-colors duration-300 hover:border-white/50 hover:text-white"
                >
                  <MessageCircle className="h-4 w-4" />
                </a>
                <a
