      ...
      <div className="container-xl relative z-10 py-10 md:py-16 px-5 sm:px-8 lg:px-16">
        ...
        <div className="md:hidden">
          ...
          <div className="flex items-center gap-2.5 mb-5">
            <span className="text-white/40 text-xs">Brokered by</span>
            <img src={realBrokerLogo} alt="Real Broker" className="h-5 w-auto brightness-200 opacity-50" />
          </div>
            ...
            <div>
              ...
              <ul className="space-y-5">
                <li className="flex items-start gap-3">
                  <Phone className="h-4 w-4 text-primary/70 mt-1 shrink-0" />
                  <div>
                ...
                <li className="flex items-start gap-3">
                  <Mail className="h-4 w-4 text-primary/70 mt-1 shrink-0" />
                  <div>
