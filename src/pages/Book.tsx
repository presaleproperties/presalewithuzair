        ...
        >
          ...
          <div className="space-y-3">
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full py-3 px-4 bg-[#25D366] hover:bg-[#20bd5a] text-white font-semibold rounded-xl transition-colors"
            >
            ...
            <p className="text-xs text-muted-foreground">
              Need immediate assistance? Start a WhatsApp chat.
            </p>
          </div>
        </motion.div>
      </div>
