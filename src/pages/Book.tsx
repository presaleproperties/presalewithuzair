...
const Book = () => {
  return (
    <div className="min-h-screen min-h-[100dvh] bg-background flex flex-col">
      ...
      {/* Testimonials Section - Hidden on mobile (shown below calendar instead) */}
      ...
      <section className="flex-1 pb-16 lg:pb-4">
        <div className="container mx-auto px-3 sm:px-4 lg:px-6">
          ...
          <div className="lg:hidden">
            ...
            {/* Mobile Testimonials - Below calendar */}
            <div className="mt-6 pt-4 border-t border-border/30">
              ...
              <div className="flex gap-2 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide -mx-3 px-3">
                {testimonials.map((testimonial, index) => (
                  <a
                    key={index}
                    href={GOOGLE_REVIEWS_URL}
            ...
            {/* Extra space so Safari bottom bar doesn't cover content */}
            <div className="h-8" />
          </div>
