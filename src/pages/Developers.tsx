      ...
      <main>
        ...
        <section className="dark-section relative min-h-[90vh] overflow-hidden flex items-center">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[40%] pointer-events-none">
            ...
            <div className="absolute bottom-10 left-[20%] w-16 h-16 md:w-24 md:h-24 rounded-full bg-primary/15 blur-xl" />
            <div className="absolute bottom-32 left-[25%] w-24 h-24 md:w-40 md:h-40 rounded-full bg-primary/12 blur-3xl" />
            <div className="absolute bottom-16 left-[35%] w-16 h-16 md:w-28 md:h-28 rounded-full bg-primary/12 blur-2xl" />
            <div className="absolute bottom-24 right-[20%] w-28 h-28 md:w-44 md:h-44 rounded-full bg-primary/12 blur-3xl" />
            <div className="absolute bottom-8 right-[30%] w-20 h-20 md:w-32 md:h-32 rounded-full bg-primary/15 blur-2xl" />
        ...
        <section className="dark-section relative section-y-lg bg-background overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[60%] pointer-events-none">
            ...
            <div className="absolute bottom-20 right-[15%] w-32 h-32 md:w-48 md:h-48 rounded-full bg-primary/10 blur-3xl" />
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full h-full bg-gradient-to-t from-primary/5 via-transparent to-transparent" />
          </div>
