...
const faqs: FunnelFAQ[] = [
  {
    ...
    answer:
      "I'm Uzair Muhammad — buyer-only presale specialist covering Surrey, Langley, Abbotsford, Coquitlam, Delta, Burnaby, Chilliwack and Maple Ridge. 450+ units sold, $200M+ in sales volume, 4.9★ from 36 Google reviews. I don't represent developers — only buyers.",
  },
  {
